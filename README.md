...
[![Anonymous Code](https://img.shields.io/badge/Code-anonymous.4open.science-lightgrey.svg)](https://anonymous.4open.science/r/NS-VLA)
...
```bash
# Download the anonymized repository from https://anonymous.4open.science/r/NS-VLA
cd NS-VLA
